...
template/
├── integrated/
│   └── ALL_IN_RULE.md         ← 單檔整合套餐（v1.4.0-all-in-one）
└── modular/
    ├── SOUL.md                ← 認知引擎套餐（v13.1.2-deterministic）
    ├── RULE.md                ← 運行合約套餐（v2.5.1-agent-optimized）
    └── SKILL.md               ← SWDD 框架套餐（v2.4.1-deterministic-actionable）
```
...
| **版本獨立性** | v1.4.0 自有版本號 | 各自獨立版本號（13.1.2 / 2.5.1 / 2.4.1） |
